...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['applicant_id'], ['applicants.user_id'], name=op.f('resumes_applicant_id_fkey')),
    ...
    sa.ForeignKeyConstraint(['resume_id'], ['resumes.id'], name=op.f('employment_records_resume_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('employment_records_pkey'))
    )
    op.create_table('resume_contact',
    sa.Column('resume_id', sa.Integer(), nullable=False),
    sa.Column('contact_id', sa.Integer(), nullable=False),
    sa.Column('extra_data', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['contact_id'], ['contacts.id'], name=op.f('resume_contact_contact_id_fkey')),
    sa.ForeignKeyConstraint(['resume_id'], ['resumes.id'], name=op.f('resume_contact_resume_id_fkey')),
    sa.PrimaryKeyConstraint('resume_id', 'contact_id', name=op.f('resume_contact_pkey'))
    )
    op.create_table('resume_education',
    sa.Column('resume_id', sa.Integer(), nullable=False),
    sa.Column('education_id', sa.Integer(), nullable=False),
    sa.Column('end_year', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['education_id'], ['educations.id'], name=op.f('resume_education_education_id_fkey')),
    sa.ForeignKeyConstraint(['resume_id'], ['resumes.id'], name=op.f('resume_education_resume_id_fkey')),
    sa.PrimaryKeyConstraint('resume_id', 'education_id', name=op.f('resume_education_pkey'))
    )
    op.create_table('resume_personal_quality',
    sa.Column('resume_id', sa.Integer(), nullable=False),
    sa.Column('personal_quality_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['personal_quality_id'], ['personal_qualities.id'], name=op.f('resume_personal_quality_personal_quality_id_fkey')),
    sa.ForeignKeyConstraint(['resume_id'], ['resumes.id'], name=op.f('resume_personal_quality_resume_id_fkey')),
    sa.PrimaryKeyConstraint('resume_id', 'personal_quality_id', name=op.f('resume_personal_quality_pkey'))
    )
