...
from src.vacancy_responses.models import VacancyResponse
...
class VacancyResponseService:
    ...
    async def create_vacancy_response(
        ...
        vacancy_response = VacancyResponse(
            ...
            status_id=VacancyResponseStatus.WAITING_FOR_REVIEW.value,
        )
    ...
    async def update_vacancy_response_status(
        self, vacancy_id: int, status_id: int
    ) -> VacancyResponse:
        vacancy_response = await self.get_by_id()
