...
class UsersCBV:
    ...
    async def register_as_recruiter(
        ...
        return await self.user_service.create_recruiter(recruiter_data)
    ...
    async def register_as_applicant(
        ...
        return await self.user_service.create_applicant(applicant_data)
    ...
    async def update_recruiter(
        ...
        return await self.user_service.update_recruiter(id, recruiter_data)
