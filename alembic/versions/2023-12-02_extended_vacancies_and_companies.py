...
def upgrade() -> None:
    ...
    op.create_table('required_experiences',
    sa.Column('id', sa.Integer(), sa.Identity(always=False), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    ...
    op.create_foreign_key(op.f('vacancies_rate_id_fkey'), 'vacancies', 'rates', ['rate_id'], ['id'])
    op.create_foreign_key(op.f('vacancies_experience_id_fkey'), 'vacancies', 'required_experiences', ['experience_id'], ['id'])
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(op.f('vacancies_experience_id_fkey'), 'vacancies', type_='foreignkey')
